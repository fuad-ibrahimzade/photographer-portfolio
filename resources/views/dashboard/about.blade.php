                    ...
                    @endif
                        ...
                        <form action="/about/update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row mb-2">
                              ...
                              <input type="text" name="title" maxlength="100" class="form-control" value="{{ old('title', $about->title) }}" required>
                            </div>
                            <div class="col-12 mb-2">
                              <textarea rows="5" maxlength="5000" name="desc" class="form-control" required>{{ old('desc', $about->desc) }}</textarea>
                            </div>
